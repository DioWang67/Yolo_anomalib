...
| Query inspection and review history | `docs/INSPECTION_DATABASE.md` | `tools/rebuild_inspection_database.py` |
...
- `docs/INSPECTION_DATABASE.md`: inspection schema, indexed artifacts, review
  history, rebuild command, and example operational queries.
