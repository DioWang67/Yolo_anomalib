...
class MvCamera:
    ...
    def MV_CC_EnumDevicesEx(nTLayerType, stDevList, strManufacturerName):
        ...
        return MvCamCtrldll.MV_CC_EnumDevicesEx(
            c_uint(nTLayerType), byref(
                stDevList), strManufacturerName.encode("ascii")
        )
    ...
    def MV_CC_EnumDevicesByInterface(self, stDevList):
        MvCamCtrldll.MV_CC_EnumDevicesByInterface.argtype = (
            c_void_p, c_void_p)
    ...
    def MV_GIGE_ForceIpEx(self, nIP, nSubNetMask, nDefaultGateWay):
        ...
        return MvCamCtrldll.MV_GIGE_ForceIpEx(
            self.handle, c_uint(nIP), c_uint(
                nSubNetMask), c_uint(nDefaultGateWay)
        )
