...
# < \~chinese 未知设备类型，保留意义       \~english Unknown Device Type, Reserved
...
# < \~chinese CameraLink设备            \~english GenTL CameraLink Device
...
# < \~chinese 最大支持的GenTL数量          \~english The maximum number of GenTL supported
...
# < \~chinese 网络流量和丢包信息              \~english Network traffic and packet loss information
MV_MATCH_TYPE_NET_DETECT = 0x00000001
# < \~chinese host接收到来自U3V设备的字节总数 \~english The total number of bytes host received from U3V device
...
# < \~chinese 115200       \~english 115200
MV_CAML_BAUDRATE_115200 = 0x00000010
# < \~chinese 230400       \~english 230400
MV_CAML_BAUDRATE_230400 = 0x00000020
# < \~chinese 460800       \~english 460800
MV_CAML_BAUDRATE_460800 = 0x00000040
# < \~chinese 921600       \~english 921600
MV_CAML_BAUDRATE_921600 = 0x00000080
# < \~chinese 最大值       \~english Auto Max
MV_CAML_BAUDRATE_AUTOMAX = 0x40000000

# \~chinese 异常消息类型    \~english Exception message type
# < \~chinese 设备断开连接              \~english The device is disconnected
MV_EXCEPTION_DEV_DISCONNECT = 0x00008001
# < \~chinese SDK与驱动版本不匹配       \~english SDK does not match the driver version
